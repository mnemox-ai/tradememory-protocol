...
- **1293 tests passing** (1233 + 60 strategy validator), 2 skipped（最後 push `359167b` 2026-04-03）
...
- **18 MCP tools** (新增 validate_strategy), 35+ REST endpoints, Evolution Engine + OWM 5 memory types
