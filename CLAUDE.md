...
- **1332 tests passing** (1253 + 60 strategy validator + 11 legitimacy + 12 property-based + 5 integration - 9 removed), 2 skipped
- **17 MCP tools** (刪除 store_trade_memory/recall_similar_trades), 35+ REST endpoints
- **5 層記憶真正互通**：Semantic↔Episodic（drift detection），Procedural（hold time/Kelly/disposition），Affective←Procedural（behavioral risk）
